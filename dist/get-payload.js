...
var resend = new resend_1.Resend(process.env.RESEND_API_KEY); // use your Resend API key here
resend.domains.create({ name: "gmail.com" }); // replace with your domain name here
                ...
                case 0:
                    ...
                    if (!cached.promise) {
                        cached.promise = payload_1.default.init(__assign({ email: {
                                ...
                                // fromAddress: "msnjy12o52o@gmail.com", // include your 'from' address here
                                fromAddress: "<onboarding@resend.dev>",
                                fromName: "DigitalBazaar",
