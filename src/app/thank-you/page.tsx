...
const ThankYouPage = async ({ searchParams }: PageProps) => {
  ...
  // getting the actual order this page is for
          ...
          <div className="lg:col-start-2">
            ...
            {order._isPaid ? (
              <p className="mt-2 text-base text-muted-foreground">
                ...
                download below. We&apos;ve send your recepit and order details
                to{" "}
              ...
              <p className="mt-2 text-base text-muted-foreground">
                We appreaciate your order, and we&apos;re currently processing
            ...
            <div className="mt-16 text-sm font-medium">
                      ...
                      <div className="flex-auto flex flex-col justify-between">
                        ...
                        {order._isPaid ? (
                          <a
                            ...
                            className="text-blue-600 hover:underline underline-off-2"
                          >
                            Download asset
                          </a>
                        ) : null}
              ...
              <div className="space-y-6 border-t border-gray-200 pt-6 text-sm font-md text-muted-foreground">
